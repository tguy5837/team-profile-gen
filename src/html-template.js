    ...
    return `
        <div class="card m-2" style="width: 18rem;">
            <div class="bg-info">
                ...
                <h3 class="px-2 text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cup-hot" viewBox="0 0 16 16">
    ...
    const engineerHtmlArr = engineerArr.map(engineer => {
        return `<div class="card m-2" style="width: 18rem;">
            <div class="bg-info">
                    ...
                    <h3 class="px-2 text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench-adjustable-circle" viewBox="0 0 16 16">
            ...
            <div class="card-body">
                ...
                <p class="card-text border p-2">Github: <a
                            href="https://github.com/${engineer.getGithub()}" target="_blank">${engineer.getGithub()}</a>
                </p>
            </div>
        </div>
        `;
    ...
    const internHtmlArr = internArr.map(intern => {
        return `<div class="card m-2" style="width: 18rem;">
            <div class="bg-info">
                    ...
                    <h3 class="px-2 text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
            ...
            <div class="card-body">
                ...
                <p class="card-text border p-2">Email: <a href="mailto:${intern.getEmail()}">${intern.getEmail()}</a>
                </p>
...
<body>
    <header class="d-flex justify-content-center p-4 bg-secondary text-light">
        <h1><svg id="header-svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
        <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/>
        <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
      </svg> ${manager.name}'s Team</h1>
    </header>
    <main>
